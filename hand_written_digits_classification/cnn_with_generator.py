...
#Using TF settings in format: (num_samples, 3, 32, 32)
...
os.makedirs('CNN_Image_Generated')
X_train2=X_train[:2]
print("Saving genrated files")


for X_batch in datagen.flow(np.array(X_train2), batch_size=1, save_to_dir='CNN_Image_Generated', save_prefix='aug', save_format='png'):
